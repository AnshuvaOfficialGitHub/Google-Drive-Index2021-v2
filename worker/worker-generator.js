...
<div class="mdui-container">
    <br><br>
    <a href="https://github.com/AnshuvaOfficialGitHub/Google-Drive-Index2021-v2"><img border="0" alt="AnshuvaOfficialGitHub" src="https://cdn.jsdelivr.net/gh/AnshuvaOfficialGitHub/Google-Drive-Index2021-v2@2.0/images/Google-Drive-Index2021-image.png" height="30px"></a><h3>Google-Drive-Index-Generator-2021-v2</h3>
    <br>
    <div class="mdui-row">
        <div class="mdui-col-sm-2">
            <a class="mdui-btn mdui-color-theme-accent mdui-ripple"
               ...
               target="_blank">1. Get Authentication Code From Your Google Account</a>
        </div>
    </div>
    <br><br>
    <div class="mdui-row">
    ...
    <center><h5>© <span id="year"></span> - AnshuvaOfficialGitHub</h5></center>
</div>
